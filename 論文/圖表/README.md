...
### iOS App 截圖 (`系統截圖/ios-app/`)

截圖由 XCUITest 自動化測試擷取，解析度為 iPhone 16 模擬器原始解析度（1179×2556px @3x）。

| 編號 | 截圖內容 | 對應章節 | 備註 |
|------|---------|---------|------|
| SS-iOS-01 | App 首頁 | 3.10, 4.6 | 五大功能入口 + 伺服器連線狀態 |
| SS-iOS-02 | 用藥清單頁 | 4.6 | Profile 切換 + 時段篩選（全部/早上/中午/晚上/睡前） |
| SS-iOS-03 | 藥師諮詢列表 | 4.6 | AI 藥物諮詢入口 + 歷史紀錄 |
| SS-iOS-04 | AI 諮詢對話 | 4.6 | 對話介面 + 免責聲明 + 輸入框 |
| SS-iOS-05 | 個人設定頁 | 4.6 | 帳號、外觀（字體/主題/色彩）、安全與健康、通知、版本 |
| SS-iOS-06 | 藥物搜尋 | 4.6 | 搜尋輸入框 + 搜尋紀錄 |
| SS-iOS-07 | 拍照辨識 | 4.6 | 相機拍照 / 相簿選取 |
| SS-iOS-08 | 用藥時段篩選 | 4.6 | 時段 Tab 篩選功能 |
